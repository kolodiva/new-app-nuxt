...
// const seoText =
//   this.props.isMain && this.props.isMain === true
//     ? "nomenklator/getSeoText"
//     : "nomenklator/getSeoText";
...
export default {
  ...
  computed: {
    seoText() {
      const pathStore =
        this.isMain === "true"
          ? "nomenklator/getSeoTextMain"
          : "nomenklator/getSeoText";

      return this.$store.getters[pathStore];
    },
    // ...mapGetters({
    //   seoText: "nomenklator/getSeoText",
    // }),
    // nomenklator() {
    //   return this.getSeoText({ isMain: true });
    // },
  },
};
</script>
